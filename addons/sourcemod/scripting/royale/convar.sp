...
void ConVar_Init()
{
	...
	fr_zone_startdisplay = CreateConVar("fr_zone_startdisplay", "5.0", "", _, true, 0.0);
	fr_zone_display = CreateConVar("fr_zone_display", "5.0", "", _, true, 0.0);
	fr_zone_shrink = CreateConVar("fr_zone_shrink", "5.0", "", _, true, 0.0);
